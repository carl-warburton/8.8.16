...
dayNames.each do |day|
  ...
  puts "What was the temperature on #{day}"
...
table =Terminal::Table.new :title => "Temp Conversion", :headings => ['day','celsius','Fahrenheit'],:rows => rows
